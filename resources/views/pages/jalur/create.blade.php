        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah jalur</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Tambah jalur</h6>
            </nav>
                ...
                <form action="{{ route('jalur.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('kuota') is-invalid @enderror" type="text"
                            value="{{ old('nama') }}" name="kuota" id="kuota">
                        @error('kuota')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <button type="submit" class="btn bg-gradient-info btn-sm">Save</button>
                </form>
            </div>
        </div>
    </div>
